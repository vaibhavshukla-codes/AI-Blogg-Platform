...
const { protect, optionalProtect, authorize, canModifyPost } = require('../middleware/auth');
...
router.put('/:slug', protect, loadPostBySlug, canModifyPost, validatePostUpdate, updatePost);
